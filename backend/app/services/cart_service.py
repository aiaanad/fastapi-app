...
class CartService:
    ...
    def add_to_cart(self, cart_data: Dict[int, int], item: CartItemCreate) -> Dict[int, int] | None:
    ...
    def update_cart_item(self, cart_data: Dict[int, int], item: CartItemUpdate) -> Dict[int, int] | None:
